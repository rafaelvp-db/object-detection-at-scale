...
# MAGIC %md
# MAGIC 
# MAGIC ## Object Detection with DETR - a minimal implementation
# MAGIC 
# MAGIC In this notebook we show a demo of DETR (Detection Transformer), with slight differences with the baseline model in the paper.
# MAGIC 
# MAGIC We show how to define the model, load pretrained weights and visualize bounding box and class predictions.
# MAGIC 
# MAGIC Let's start with some common imports.
...
# MAGIC %md
# MAGIC 
# MAGIC As you can see, DETR architecture is very simple, thanks to the representational power of the Transformer. There are two main components:
# MAGIC 
